          ...
          child: Column(
            children: [
              ...
              Row(
                ...
                children:   [
                  const Text('Sheqle',style: TextStyle(fontSize: 27,color: Colors.black),),
              ...
              const Spacer(flex: 1),
              Text("$_answer $_typeCurrency" ,style: const TextStyle(fontSize: 35,fontWeight: FontWeight.w800),),
              const Spacer(flex: 2),
                ...
                child: InkWell(
                  onTap: () {
                    setState(() {
                      ...
                      if (index0 == false) { // $
                        _multiplicationValue = 3.5  ;
                        _typeCurrency = "\$" ;
                      }
                      if (index1 == false) { // Kd
                        _multiplicationValue = 11.48  ;
                        _typeCurrency = "Kd" ;
                      }
                      if (index2 == false) { // ¥
                        _multiplicationValue = .026  ;
                        _typeCurrency = "¥" ;
                      }
                      if (index3 == false) { // £
                        _multiplicationValue = 4.20  ;
                        _typeCurrency = "£" ;
                      }
                      if (index4 == false) { // €
                        _multiplicationValue = 3.61  ;
                        _typeCurrency = "€" ;
                      }
